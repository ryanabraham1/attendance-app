...
export default async function PracticesPage() {
  ...
  return <div className="page-wrap"><header className="page-header"><p className="eyebrow">Session log</p><h1>Practices</h1><p>Start now or reopen an earlier practice.</p></header><div className="two-column">
    <section className="panel quick-start-panel"><CalendarPlus size={28} /><p className="eyebrow">New practice</p><h2>Ready when you are.</h2><p>The active roster starts marked here. On the next screen, tap only the exceptions.</p><form action={addPractice}><SubmitButton className="button button-primary start-practice-button" pendingText="Starting…"><ClipboardCheck size={19} />Start practice</SubmitButton></form></section>
