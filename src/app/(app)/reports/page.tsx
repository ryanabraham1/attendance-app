import { BarChart3, Check, Clock3, ShieldCheck, UserX } from "lucide-react";
...
export default async function ReportsPage() {
  const reports = await getMemberReports();
  return <div className="page-wrap"><header className="page-header"><p className="eyebrow">Attendance analysis</p><h1>Member reports</h1><p>Rates count present and late as attended. Excused practices do not affect the percentage.</p></header><section className="panel report-panel">
