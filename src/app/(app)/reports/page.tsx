...
export default async function ReportsPage() {
  ...
  return <div className="page-wrap"><header className="page-header"><p className="eyebrow">{group ? `${group} attendance` : "Attendance analysis"}</p><h1>{group ? `${group} reports` : "Member reports"}</h1><p>Rates count present and late as attended. Excused practices do not affect the percentage.</p></header><section className="panel report-panel">
